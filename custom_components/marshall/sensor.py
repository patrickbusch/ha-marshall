...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    add_entities([MarshallNameSensor(), MarshallVolumeSensor(), MarshallSourceSensor()])
...
class MarshallSourceSensor(Entity):
    ...
    def update(self):
        ...
        This is the only method that should fetch new data for Home Assistant.
        """
        self._state = self.hass.data[DOMAIN]['device'].get_source()